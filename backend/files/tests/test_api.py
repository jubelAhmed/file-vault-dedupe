...
class FileAPITestCase(APITestCase):
    ...
    def test_file_list_user_isolation(self):
        ...
        self.client.post(
            ...
            {'file': other_file},
            format='multipart',
            HTTP_UserId=self.other_user_id
        )
    ...
    def test_storage_stats_success(self):
        ...
        self.assertAlmostEqual(
            response.data['quota_usage_percentage'],
            (original_used / limit) * 100,
            places=4
        )
    ...
    def test_file_with_special_characters(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.data['data']['original_filename'], 'file with spaces & symbols!.txt')
    ...
    def test_multi_user_deduplication_workflow(self):
        ...
        dedup_response = self.client.get('/api/files/deduplication_stats/', HTTP_UserId=self.user_id)
